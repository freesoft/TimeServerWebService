 ...
 * 
 */
@WebServiceClient(name = "TimeServerImplService", targetNamespace = "http://potatosoft.com/", wsdlLocation = "http://localhost:5000/ts?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:5000/ts?wsdl");
