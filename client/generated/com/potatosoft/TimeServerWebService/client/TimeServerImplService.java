...
package com.potatosoft.TimeServerWebService.client;
 ...
 * 
 */
@WebServiceClient(name = "TimeServerImplService", targetNamespace = "http://potatosoft.com/", wsdlLocation = "META-INF/wsdl/TimeServerImplService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName TIMESERVERIMPLSERVICE_QNAME = new QName("http://potatosoft.com/", "TimeServerImplService");

    static {
        TIMESERVERIMPLSERVICE_WSDL_LOCATION = com.potatosoft.TimeServerWebService.client.TimeServerImplService.class.getClassLoader().getResource("META-INF/wsdl/TimeServerImplService.wsdl");
        WebServiceException e = null;
        if (TIMESERVERIMPLSERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/TimeServerImplService.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
    ...
    public TimeServer getTimeServerImplPort() {
        return super.getPort(new QName("http://potatosoft.com/", "TimeServerImplPort"), TimeServer.class);
    }
    ...
    public TimeServer getTimeServerImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://potatosoft.com/", "TimeServerImplPort"), TimeServer.class, features);
    }
